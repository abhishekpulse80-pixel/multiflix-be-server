...
export const updateEarningRateBodySchema = z
  ...
  .strict()
  .refine(
    (v) => v.ratePerMinute !== undefined || v.isActive !== undefined,
    { message: 'At least one of ratePerMinute or isActive must be provided' },
  );

export type UpdateEarningRateBody = z.infer<typeof updateEarningRateBodySchema>;
