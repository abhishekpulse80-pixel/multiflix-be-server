...
import { UserModel, type UserGender } from '../models/user.model.js';
...
async function main(): Promise<void> {
  ...
  console.log(
    `Seed users done: ${String(created)} inserted, ${String(updated)} updated (${String(SEED_COUNT)} total).`,
  );
  console.log(
    `Login with any ${String(SEED_COUNT)} emails matching multiflix.seed.**@multiflix.test`,
  );
