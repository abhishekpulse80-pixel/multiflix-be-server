...
const AUTHOR_SEED_NUMBERS = [1, 3, 5, 8, 12];
...
const BLOG_BLUEPRINTS = [
    {
        ...
        description: 'Weekly habits, deep work blocks, and why boring systems beat motivation spikes.',
        durationSeconds: 10,
    ...
    },
    {
        ...
        description: 'From leitmotifs to silence — a long listen with scene breakdowns.',
        durationSeconds: 10,
    ...
    },
    {
        ...
        description: 'Scope creep, test users, and the one feature we cut at the last minute.',
        durationSeconds: 10,
    ...
    },
    {
        ...
        description: 'Audience questions on protein, sleep, and caffeine timing.',
        durationSeconds: 10,
        tags: ['health', 'qna'],
        status: 'published',
