...
function parseGoogleSignInClientIds() {
...
function parseAppleSignInAudiences() {
...
function parseChatInactiveDays() {
...
export const env = {
    ...
    passwordResetJwtExpiresIn: process.env.PASSWORD_RESET_JWT_EXPIRES_IN?.trim() || '15m',
